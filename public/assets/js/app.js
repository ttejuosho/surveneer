...
$(function() {
  ...
  $('#editSurvey').on('click', () => {
    ...
    if ($('#preSurveyInstructions').val().trim().length > 0) {
      ...
      $('#preSurveyInstructionsRow').removeClass('d-none');
    }
    if ($('#postSurveyInstructions').val().trim().length > 0) {
      $('#postSurveyInstructions').attr('readonly', false);
    } else {
      $('#postSurveyInstructionsRow').removeClass('d-none');
    }
    if ($('#surveyNotes').val().trim().length > 0) {
      $('#surveyNotes').attr('readonly', false);
    } else {
      $('#surveyNotesRow').removeClass('d-none');
    }
    if ($('#surveyTOU').val().trim().length > 0) {
      $('#surveyTOU').attr('readonly', false);
    } else {
      $('#surveyTOURow').removeClass('d-none');
    }
